...
$domain="";
if(isset($_GET["q"])) $domain=$_GET["q"];
?>
<!DOCTYPE html PUBLIC>
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">

<head>
	<title>Whois v1.0</title>
...
<div align=center>
	<form method=get action=''>
		...
		<input name=q type=text value='<?=$domain?>'>
		<button>WHOIS</button>
	</form>
</div>
<hr/>
...
if($domain) {
	...
	elseif(ValidateDomain($domain)) {
		$result = LookupDomain($domain,$whoisservers);
	}
...
<?php
function LookupDomain($domain,$whoisservers) {
